"""This is a Bluesky plugin for beta using atprototools."""
...
class BetaBluesky(BetaPluginTemplate):
    """
    Bluesky plugin for beta using atprototools.
    """

    def __init__(self):
        super().__init__()
        self._name = "beta-bluesky"
        self._version = "0.1.0"
