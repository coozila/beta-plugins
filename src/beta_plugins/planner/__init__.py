"""This is a task planning system plugin for beta. It is able to create tasks, elaborate a plan, improve upon it
...
class PlannerPlugin(BetaPluginTemplate):
    """
    This is a task planner system plugin for beta which 
    adds the task planning commands to the prompt.
    """

    def __init__(self):
        super().__init__()
        self._name = "beta-Planner-Plugin"
        self._version = "0.1.1"
        self._description = "This is a simple task planner module for beta. It adds the run_planning_cycle " \
