...
After you clone the plugin from the original repo (https://github.com/rihp/beta-planner-plugin) Add it to the plugins folder of your beta repo and then run beta
...
```
zip -ru ../fork/plugins/planner.zip . ; cd ../fork && python3 -m beta --debug 
```

then you need to cd back to 
```
cd ../beta-planner-plugin    
```
