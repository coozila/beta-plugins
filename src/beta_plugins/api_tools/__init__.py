...
class BetaApiTools(BetaPluginTemplate):
    """
    API Tools plugin for beta.
    """

    def __init__(self):
        super().__init__()
        self._name = "beta-api-tools"
        self._version = "0.1.0"
        self._description = "Allow beta to make API calls to outside services."
