...
class BetaRandomValues(BetaPluginTemplate):
    """
    Random Values plugin for beta.
    """

    def __init__(self):
        super().__init__()
        self._name = "beta-random-values"
        self._version = "0.1.0"
        self._description = "Enable beta with the power of random values."
