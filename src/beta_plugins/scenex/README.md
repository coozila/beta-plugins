# beta SceneXplain Plugin: Explore image storytelling beyond pixels
...
<img width="1116" alt="beta-scenex-plugin" src="https://user-images.githubusercontent.com/492616/234332762-642bfd6c-045e-426d-b8cd-70aaf53ff894.png">
...
Follow these steps to configure the beta SceneX Plugin:
...
ALLOWLISTED_PLUGINS=BetaSceneXPlugin
```

## 🧪 Test the beta SceneX Plugin
...
2. **Run beta:**
   Launch beta, which should use the SceneXplain plugin to describe an image.
