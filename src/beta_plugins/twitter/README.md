...
A plugin adding twitter API integration into beta
...
2. Add this chunk of code along with your twitter API information to the `.env` file within beta:
...
ALLOWLISTED_PLUGINS=BetaTwitter
